...
- Limited forensic analysis and incident response capabilities.
...
Get-ItemProperty `
  ...
  -Name 'EnableScriptBlockLogging'
Notes
Script Block Logging records full PowerShell command content, including de-obfuscated commands.

This setting improves visibility into attacker tradecraft and post-exploitation activity.
